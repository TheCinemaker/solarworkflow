// Inline SVG icon set — stroke style (lucide-react inspired)
// Use: <Icon name="bolt" size={16} color="var(--blue)" />
...
const PATHS = {
  ...
  'thumbs-up': <path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9A2 2 0 0 0 19.66 9H14zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3" />,
  plus: (
    <>
  ...
  sparkles: (
    <>
      <path d="M12 3l1.91 5.79L20 10.5l-5.09 2.71L12 19l-2.91-5.79L4 10.5l6.09-1.71L12 3z" />
    </>
  ),
  home: (
    <>
